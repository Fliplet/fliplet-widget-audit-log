...
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(509);
  ...
  return _c(
    ...
    [
      _c(
        ...
        [_vm._m(0), _vm._v(" "), _c("RangeDatePicker")],
        1
      ),
      _vm._v(" "),
      _vm.isLoading
    ...
    return _c("div", { staticClass: "alert alert-info" }, [
      ...
      _c("ol", [
        _c("li", [
          _c(
            "a",
            { attrs: { href: "https://help.fliplet.com/audit-log/#1" } },
        ...
        _c("li", [
          _c(
            "a",
            { attrs: { href: "https://help.fliplet.com/audit-log/#2" } },
            [
              _vm._v(
        ...
        _c("li", [
          _c(
            "a",
            { attrs: { href: "https://help.fliplet.com/audit-log/#3" } },
        ...
        _c("li", [
          _c(
            "a",
            { attrs: { href: "https://help.fliplet.com/audit-log/#4" } },
            [
              _vm._v(
        ...
        _c("li", [
          _c(
            "a",
            { attrs: { href: "https://help.fliplet.com/audit-log/#5" } },
...
/* harmony import */ var _components_RangeDatePicker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(510);
...
/* harmony import */ var _services_logs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(496);
/* harmony import */ var _libs_bus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(497);
/* harmony import */ var _libs_tracking__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(498);
/* harmony import */ var _libs_permalink__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(495);
/* harmony import */ var _config_sample_data__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(499);
/* harmony import */ var _config_log_table__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(500);
/* harmony import */ var _libs_logs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(502);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    ...
    return {
      ...
      userTypes: _config_log_table__WEBPACK_IMPORTED_MODULE_6__["userTypes"],
      columns: _config_log_table__WEBPACK_IMPORTED_MODULE_6__["columns"],
  ...
  methods: {
    initTable: function initTable() {
      ...
      this.table = $(this.$refs.table).DataTable({
        ...
        columnDefs: _config_log_table__WEBPACK_IMPORTED_MODULE_6__["columnDefs"],
        searchCols: searchCols,
        order: [[0, 'desc']],
        serverSide: true,
        ajax: function ajax(data, callback, settings) {
          var _getDates2 = Object(_store__WEBPACK_IMPORTED_MODULE_0__["getDates"])(),
              startDate = _getDates2.startDate,
              endDate = _getDates2.endDate;
          ...
          data.columns.forEach(function (col) {
            ...
            if (col.name === 'Category') {
              ...
              _this.$set(_this.query, 'userType', Object(_libs_logs__WEBPACK_IMPORTED_MODULE_7__["getUserTypeQuery"])(value));
            }
              ...
              case 'User':
                {
                  ...
                  var impersonateUserEndAsEmail = value.match(new RegExp("^".concat(regExToMatchEmailStr, " as$"), 'i')); // Prepare where data for normal and impersonate user email check

                  var userEmailDataCheck = {
                    user: {
                      type: null,
                      email: {
                        $iLike: "%".concat(value, "%")
                  ...
                  if (impersonateUserEmails) {
                    ...
                    where.$or = [userEmailDataCheck, studioUserDataCheck];
                  }
      ...
      this.table.on('draw', function () {
        ...
        setTimeout(function () {
          Object(_libs_logs__WEBPACK_IMPORTED_MODULE_7__["clampJSONData"])();
          Object(_store__WEBPACK_IMPORTED_MODULE_0__["setUIIsLoading"])(false);
          Fliplet.Widget.autosize();
        }, 50);
      });
    ...
    getData: function getData() {
      ...
      if (Fliplet.Env.get('development')) {
        return new Promise(function (resolve) {
          setTimeout(function () {
            resolve(_config_sample_data__WEBPACK_IMPORTED_MODULE_5__["default"]);
          }, 300);
        });
      }
    ...
    onChange: function onChange(event, colIndex) {
      ...
      if (col && col.name === 'Log type') {
        ...
        Object(_libs_permalink__WEBPACK_IMPORTED_MODULE_4__["writeHash"])({
          type: sanitizedValue || null
        });
      }
    ...
    attachObservers: function attachObservers() {
      var debouncedClamp = Fliplet.Utils.debounce(_libs_logs__WEBPACK_IMPORTED_MODULE_7__["clampJSONData"], 300);
      $(window).on('resize', debouncedClamp);
      $(document).on('click', '[data-json] .btn-toggle', _libs_logs__WEBPACK_IMPORTED_MODULE_7__["toggleClamping"]).on('click', '[data-json] .btn-inspect', _libs_logs__WEBPACK_IMPORTED_MODULE_7__["inspectData"]);
    }
  },
...
/* harmony import */ var _libs_permalink__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(495);


var dateRangeParts = _config_dates__WEBPACK_IMPORTED_MODULE_0__["defaultDateRange"].split(','); // Filter state encoded in the URL hash, read once at module init.
// Widget data (overlay integration) always takes precedence over the hash.

var _hash = Object(_libs_permalink__WEBPACK_IMPORTED_MODULE_1__["readHash"])() || {}; // Lazy-loaded widget data from the `data` URL parameter (e.g. when opened as an overlay).
...
function initFiltersFromWidgetData() {
  ...
  var typeFilter = wd.typeFilter || _hash.type;
  var dataFilter = wd.dataFilter || _hash.data;
...
function getInitialDates() {
  ...
  if (wd.startDate && wd.endDate) {
    ...
    source = {
      startDate: _hash.start,
      endDate: _hash.end
    };
  }

  if (source) {
    var start = moment(source.startDate);
    var end = moment(source.endDate);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "readHash", function() { return readHash; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "writeHash", function() { return writeHash; });
/**
 ...
 */
var KEYS = ['start', 'end', 'range', 'type', 'data'];
function readHash() {
  try {
...
function writeHash(next) {
  try {
    var merged = Object.assign({}, readHash() || {}, next);
    var parts = [];
    ...
    var hash = parts.length ? "#".concat(parts.join('&')) : '';

    if (hash !== window.location.hash) {
      window.history.replaceState(null, '', "".concat(window.location.pathname).concat(window.location.search).concat(hash));
    }
  } catch (err) {
...
/* harmony import */ var _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(501);
...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(503);
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _config_log_table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(500);
...
var arrayWithHoles = __webpack_require__(504);

var iterableToArrayLimit = __webpack_require__(505);

var unsupportedIterableToArray = __webpack_require__(506);

var nonIterableRest = __webpack_require__(508);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _RangeDatePicker_vue_vue_type_template_id_bcf7070e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(511);
/* harmony import */ var _RangeDatePicker_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(513);
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(509);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_RangeDatePicker_vue_vue_type_template_id_bcf7070e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(512);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_5_0_node_modules_vue_loader_lib_index_js_vue_loader_options_RangeDatePicker_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(514);
...
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(503);
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var vue2_daterange_picker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(515);
...
/* harmony import */ var _DateDropdown__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(516);
/* harmony import */ var _libs_bus__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(497);
/* harmony import */ var _libs_tracking__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(498);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(493);
/* harmony import */ var _libs_permalink__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(495);
/* harmony import */ var _config_dates__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(494);
/* harmony import */ var vue2_daterange_picker_dist_vue2_daterange_picker_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(521);
/* harmony import */ var vue2_daterange_picker_dist_vue2_daterange_picker_css__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(vue2_daterange_picker_dist_vue2_daterange_picker_css__WEBPACK_IMPORTED_MODULE_8__);
  ...
  methods: {
    ...
    calculateDateRange: function calculateDateRange() {
      ...
      var _range$split = range.split(','),
          ...
          value = _range$split2[0],
          _range$split2$ = _range$split2[1],
          unit = _range$split2$ === void 0 ? '' : _range$split2$;
    ...
    updateValues: function updateValues() {
      ...
      Object(_libs_tracking__WEBPACK_IMPORTED_MODULE_4__["trackEvent"])({
        ...
        label: Fliplet.Utils.get(Fliplet.Utils.find(_config_dates__WEBPACK_IMPORTED_MODULE_7__["dateRanges"], {
          value: 'none'
        }), 'label')
      ...
      Object(_libs_permalink__WEBPACK_IMPORTED_MODULE_6__["writeHash"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DateDropdown_vue_vue_type_template_id_6ade968f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(517);
/* harmony import */ var _DateDropdown_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(519);
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(509);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_DateDropdown_vue_vue_type_template_id_6ade968f___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(518);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_5_0_node_modules_vue_loader_lib_index_js_vue_loader_options_DateDropdown_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(520);
...
// Imports
var ___CSS_LOADER_API_IMPORT___ = __webpack_require__(523);
